...
parser.read ("/home/pi/Documents/OnlineBiosensor/Configuration/biosensorconfig.ini") #location of biosensor configuration/parameters for floating sensor
parser2.read ("/home/pi/Documents/OnlineBiosensor/Configuration/biosensorconfig2.ini") #location of biosensor configuration/parameters for flow through sensor
import sys
import glob
import serial
...
#########DEFINITIONS OF COMMANDS FOR FLOATING SENSOR
    ...
    def OnSaveClick(self): #this save is in the parameter box
        ...
        with open ('/home/pi/Documents/OnlineBiosensor/Configuration/biosensorconfig.ini', 'w') as configfile:
    ...
    def OnStartStopClick(self): #when start is clicked
        ...
        os.chmod("/home/pi/Documents/OnlineBiosensor/BiosensingData", 0o777) #make folder write and readable for all
        parser.set('Parameters','tolerance',str(tolerance))
        parser.set('Parameters','vmin', str(Vmin))
        parser.set('Parameters','alpha1', str(alpha1))
        parser.set('Parameters','graphspan', str(graphspan))
...
##        self.parameter2.destroy()
        ...
        with open ('/home/pi/Documents/OnlineBiosensor/Configuration/biosensorconfig2.ini', 'w') as configfile2:
