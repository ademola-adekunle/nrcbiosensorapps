...
configfile1path = r'C:/OnlineBiosensorWindows_BOD_COD/Configuration/biosensorconfig.ini'
configfile2path = r'C:/OnlineBiosensorWindows_BOD_COD/Configuration/biosensorconfig2.ini'
BiosensingDataFolder = r'C:/OnlineBiosensorWindows_BOD_COD/BiosensingData'
BODExcelLocation = r'C:/OnlineBiosensorWindows_BOD_COD/BiosensingData/Calibration_Data.xlsx' #Windows. need to change for Raspberry Pi
...
##                                    global y4limit
                                    ...
                                    if BOD_fit_type == 'Linear':
                                        bodV = BOD_lin_inter + BOD_lin_coefs*Y_calculated
                                        bodV = round(bodV, 2)
                                    ...
                                    if BOD_fit_type == 'Polynomial':
                                        bodV = BOD_poly2_inter + (BOD_poly2_coefs[0][1] *Y_calculated)  + (BOD_poly2_coefs[0][2] * (Y_calculated * Y_calculated))
                                        bodV = round(bodV, 2)
                                        bodvset.set(str(bodV))

                                    #Estimate COD
                                    if COD_fit_type == 'Linear':
                                        codV = COD_lin_inter + COD_lin_coefs*Y_calculated
                                        codV = round(codV, 2)
                                    ...
                                    if COD_fit_type == 'Polynomial':
                                        codV = COD_poly2_inter + (COD_poly2_coefs[0][1] *Y_calculated)  + (COD_poly2_coefs[0][2] * (Y_calculated * Y_calculated))
                                        codV = round(codV, 2)
                                        codvset.set(str(codV))
